<?php
$url = urlencode("http://localhost/nelayan/");
return [
    /*
    |--------------------------------------------------------------------------
    | CAS Hostname
    ...
    */
    'cas_hostname'        => env('CAS_HOSTNAME', 'http://localhost:8000'),
    ...
    */
    ...
    'cas_login_url'       => env('CAS_LOGIN_URL', 'http://localhost:8000/cas/login'),
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url'      => env('CAS_LOGOUT_URL', 'http://localhost:8000/cas/logout'),
    ...
    */
    'cas_logout_redirect' => env('CAS_LOGOUT_REDIRECT', 'http://localhost:8000/cas/logout'),
